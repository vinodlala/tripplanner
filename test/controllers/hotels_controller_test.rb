...
class HotelsControllerTest < ActionController::TestCase
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post :create, hotel: { amenities: @hotel.amenities, num_stars: @hotel.num_stars, place_id: @hotel.place_id }
    end
  ...
  test "should update hotel" do
    patch :update, id: @hotel, hotel: { amenities: @hotel.amenities, num_stars: @hotel.num_stars, place_id: @hotel.place_id }
    assert_redirected_to hotel_path(assigns(:hotel))
  end
